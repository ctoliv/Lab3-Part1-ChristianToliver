...
function render() {
	...
	modelViewMatrix = mult( modelViewMatrix, rotate(30.0, vec3(1.0, 0.0, 0.0)));
	modelViewMatrix = mult( modelViewMatrix, rotate(-30.0, vec3(0.0, 1.0, 0.0)));

	var sceneMatrix = modelViewMatrix;
	...
	var secondCubeMatrix = sceneMatrix;
